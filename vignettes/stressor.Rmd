...
Once Python is installed, you can install stressor from CRAN. For your convenience, we
...
min for data \<10,000) to fit the data. Note that console output will be shown and
a progress bar will be displayed showing the progress of the fitting.
...
`create_virtualenv()` function again. There should be no problems
