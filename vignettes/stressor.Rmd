...
be prompted to press the enter key.
```{r eval=FALSE}
...
ignoring spatial autocorrelation. The purpose of this data set is to show its 
...
Now, compared to the clustered cross validation:
```{r eval=FALSE}
