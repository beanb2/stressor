...
#'
#' A score function that takes the observed and predicted values and returns a
...
#'   `R2`, `RMSLE`, and `MAPE`. And for classification the following metrics:
#'   `Accuracy`, `AUC`, `Recall`, `Prec.`, `F1`, `MCC`, and `Kappa`.
