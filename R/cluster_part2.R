...
#' @param k2 If specified, k2 represents a finer scale partitioning that can be
#'   used the balance the larger k-fold clusters. k2 must be at least double
#'   k if it is to be used effectively (the function will throw an error if
#'   it is not).
#' @param ... Additional arguments passed to [stats::kmeans()] as needed.
#' @export
cluster_part2 <- function(features, k, k_mult = 5, ...){
